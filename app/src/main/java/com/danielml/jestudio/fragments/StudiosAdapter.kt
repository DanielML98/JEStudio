...
class StudiosAdapter(private val context: Context?, private val spinningStudios: ArrayList<SpinningStudio>, private val onStudioListener: OnStudioClick) : RecyclerView.Adapter<StudiosAdapter.ViewHolder>() {
  ...
  override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
    ...
    return ViewHolder(view, onStudioListener)
  }
  ...
  inner class ViewHolder(itemView: View, private val onStudioListener: OnStudioClick) : RecyclerView.ViewHolder(itemView), View.OnClickListener {
    ...
    override fun onClick(view: View?) {
      spinningStudios.let { onStudioListener.onStudioClick(it[bindingAdapterPosition]) }
    }


  }

  interface OnStudioClick {
    fun onStudioClick(studio: SpinningStudio)
  }
}
